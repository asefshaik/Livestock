...
export default function HomeScreen({ navigation }) {
  ...
  const selected = LIVESTOCK_TYPES.find(t => t.key === selectedType) ?? LIVESTOCK_TYPES[0];
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      <View style={styles.hero}>
        ...
        <Text style={styles.heroTitle}>PashuBazaar</Text>
      ...
      >
        ...
        <View style={styles.selectedBanner}>
          <Text style={styles.selectedBannerText}>
            {selected.key === 'auto'
              ...
              : <>Scanning for: <Text style={styles.selectedBannerBold}>{selected.emoji} {selected.label}</Text></>
            }
          </Text>
        </View>
        ...
        <View style={styles.stepRow}>
          ...
          <Text style={styles.stepText}>AI detects only that animal in real time</Text>
        </View>
        <View style={styles.stepRow}>
          <View style={styles.stepBadge}><Text style={styles.stepNum}>3</Text></View>
          <Text style={styles.stepText}>Receive a health score after scanning</Text>
        </View>
        ...
        <TextInput
          ...
          returnKeyType="done"
        />
        <Text style={styles.inputHint}>Enter ID to save results to your listing</Text>

        {/* ── CTA ── */}
        <TouchableOpacity style={styles.scanButton} onPress={handleStartScan} activeOpacity={0.85}>
...
const styles = StyleSheet.create({
  ...
  heroSubtitle: { fontSize: 13, color: 'rgba(255,255,255,0.75)', marginTop: 3, letterSpacing: 0.3 },

  card: { backgroundColor: '#FAFAFA', borderTopLeftRadius: 28, borderTopRightRadius: 28 },
  ...
  input: {
    ...
    fontSize: 16, color: '#222', marginBottom: 6,
  },
  ...
  scanButtonText: { color: '#FFFFFF', fontSize: 18, fontWeight: '700', letterSpacing: 0.3 },
});
